...
\foreach \label/\position in {E/5,  F/6,  G/7,  H/8}
   {
	...
	\node (redArrowStart) at (\redOneLength * 2 * \halfSquare + \halfSquare + \xArrowSkip ,\yskip){};
	\node (blueArrowStart) at (\redOneLength * 2 * \halfSquare + \halfSquare + \xArrowSkip ,0){};
	\node (redArrowEnd) at (\redOneLength * 2 * \halfSquare + \halfSquare + \xskip - \xArrowSkip ,0){};
	\node (blueArrowEnd) at (\redOneLength * 2 * \halfSquare + \halfSquare + \xskip - \xArrowSkip ,\yskip){};
	...
	%\draw [fill=red] (\redOneLength * 2 * \halfSquare + \halfSquare + \xArrowSkip ,\yskip) circle (0.2);
